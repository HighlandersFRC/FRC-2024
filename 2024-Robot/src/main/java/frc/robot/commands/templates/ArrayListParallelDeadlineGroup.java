 ...
 */
public class ArrayListParallelDeadlineGroup extends Command {
   ...
   */
  public ArrayListParallelDeadlineGroup(Command deadline, ArrayList<Command> otherCommands) {
  ...
  public final void setDeadline(Command deadline) {
    ...
    ArrayList<Command> deadlineList = new ArrayList<Command>();
    deadlineList.add(deadline);
    addCommands(deadlineList);
    m_deadline = deadline;
  }
