...
public class FourPieceOneFarAuto extends SequentialCommandGroup {
  ...
  /** Creates a new FourPieceOneFarAuto. */
  public FourPieceOneFarAuto(Drive drive, Peripherals peripherals) {
    try {
    ...
    try {
      pathingFile2 = new File("/home/lvuser/deploy/4PieceSpikePart3.json");
    ...
    try {
      pathingFile3 = new File("/home/lvuser/deploy/5PieceCenterPart4.json");
    ...
    try {
      pathingFile4 = new File("/home/lvuser/deploy/5PiecePart5.json");
