...
public class FourPieceFarBottom231Auto extends SequentialCommandGroup {
  ...
  public FourPieceFarBottom231Auto(Drive drive, Peripherals peripherals, Intake intake, Feeder feeder, Shooter shooter, Climber climber, Lights lights, TOF tof, Proximity proximity) {
    try {
    ...
    try {
      pathingFile3 = new File("/home/lvuser/deploy/4PieceFarBottomPart4.json");
    ...
    try {
      pathingFile4 = new File("/home/lvuser/deploy/4PieceFarBottom231Part4.json");
