...
public class RunShooter extends Command {
  ...
  public RunShooter(Shooter shooter, Feeder feeder, double left, double right /* input in RPM */ ) {
  ...
  public void execute() {
    ...
    // }
    if((Math.abs(shooter.getLeftShooterRPM() - left)/left < 0.1 && Math.abs(shooter.getRightShooterRPM() + right)/right < 0.1) || Timer.getFPGATimestamp() - startTime > 3) {
      feeder.setPercent(1);
