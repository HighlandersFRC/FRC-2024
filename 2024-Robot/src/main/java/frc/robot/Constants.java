...
public final class Constants {
  ...
  public static final class SetPoints {
    ...
    public static final double [][] SHOOTING_LOOKUP_TABLE = {
      ...
      {1.40, 5.63, 56, 4500, 1},
      {1.61, 2.83, 53, 4750, 1},
      {2.02, -1.20, 48, 5000, 0.75},
      {2.31, -3.54, 44, 5125, 0.75},
      {2.72, -5.72, 38.5, 5250, 0.75},
      {3.18, -7.55, 33.5, 5500, 0.5},
      {3.53, -8.64, 31.5, 5750, 0.5},
      {3.86, -9.49, 30, 6000, 0.5},
      {4.25, -10.23, 27.5, 6250, 0.5},
      {4.68, -10.58, 26, 6500, 0.5},
      {5.08, -11.37, 24.5, 6750, 0.5},
      {5.54, -12.63, 22, 7000, 0.5}
    };
