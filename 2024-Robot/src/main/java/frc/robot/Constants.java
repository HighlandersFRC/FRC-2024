...
public final class Constants {
  ...
  public static final class SetPoints {
    ...
    public static final double [][] SHOOTING_LOOKUP_TABLE = {
      ...
      {2.02, -2.05 + LIMELIGHT_ANGLE_OFFSET, 48, 5000, 0.75, 2},
      {2.31, -4.39 + LIMELIGHT_ANGLE_OFFSET, 44, 5125, 0.75, 2},
      ...
      {5.08, -12.22 + LIMELIGHT_ANGLE_OFFSET, 25.5, 6750, 0.5, 1.5},
      {5.54, -13.48 + LIMELIGHT_ANGLE_OFFSET, 24, 7000, 0.5, 1.2},
      {6.06, -14.14 + LIMELIGHT_ANGLE_OFFSET, 22.5, 7000, 0.5, 1.2},
      {6.40, -14.29 + LIMELIGHT_ANGLE_OFFSET, 22.5, 7250, 0.5, 1.2},
      {6.9, -14.47 + LIMELIGHT_ANGLE_OFFSET, 22, 7250, 0.5, 1.2},
      {7.2, -14.56 + LIMELIGHT_ANGLE_OFFSET, 21, 7500, 0.5, 1.2}
    };
