...
public final class Constants {
  ...
  public static final class SetPoints {
    ...
    public static final double [][] SHOOTING_LOOKUP_TABLE = {
      ...
      {3.846 + DISTANCE_OFFSET, -9.49 + LIMELIGHT_ANGLE_OFFSET, 31.5, 5750, 0.5, 1.5},
      {4.247 + DISTANCE_OFFSET, -10.34 + LIMELIGHT_ANGLE_OFFSET, 29.5, 6000, 0.5, 1.5},
      {4.743 + DISTANCE_OFFSET, -11.08 + LIMELIGHT_ANGLE_OFFSET, 27.75, 6250, 0.5, 1.5},
      {5.293 + DISTANCE_OFFSET, -11.75 + LIMELIGHT_ANGLE_OFFSET, 26.75, 6500, 0.5, 1.5},
